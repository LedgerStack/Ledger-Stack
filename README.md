...
![Lock Verification Matrix](matrix.lock-verification.png)
...
![Sample Dev Ledger Report](report.sample-output.png)
...
![Control Path Failure Diagram](failure.control-paths.png)
